...
public class AndroidAudioPlayer implements AudioProcessor {
	...
	public AndroidAudioPlayer(TarsosDSPAudioFormat audioFormat, int bufferSize){
		...
		audioTrack = new AudioTrack(AudioManager.STREAM_MUSIC, (int)audioFormat.getSampleRate(), AudioFormat.CHANNEL_OUT_MONO, AudioFormat.ENCODING_PCM_16BIT, bufferSize * 2, AudioTrack.MODE_STREAM);
		audioTrack.play();
	}
