...
//Work around because apparently there are issues with playing the visualizer on a galaxy S4

package com.example.taptwisttunes.utils;
...
import com.example.taptwisttunes.R;
